...
# Import Zimu's architecture
from advance_model import MultiScale_GCN_LSTM

def build_model(fixed_adj_norm, in_feats=None, num_classes=2, share_weights=False,
                gcn_hidden=128, lstm_hidden=128, D=128, device=None, verbose=False, **kwargs):
    """
...
def load_model(model_path, fixed_adj_norm, in_feats=None, strict=True, eval_mode=True, device=None, verbose=False, **kwargs):
    """
