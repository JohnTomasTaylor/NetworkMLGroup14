...
Wraps dataset, dataloader, and adjacency construction for graph models.
"""
...
from evaluation.config import FEATURE_ROOT, EDGE_INDEX_PATH, NUM_CHANNELS, BATCH_SIZE, NUM_WORKERS, DEVICE
...
def get_dataloader(meta_path, batch_size=None, shuffle=False, num_workers=None, feature_root=None):
    ...
    root = feature_root or FEATURE_ROOT
